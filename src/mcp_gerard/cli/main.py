...
from mcp_gerard.cli.completion import (
    install_completion_script,
    show_completion_install,
)
from mcp_gerard.cli.config import create_default_config, get_config_file
from mcp_gerard.cli.discovery import get_available_tools, get_tool_info
from mcp_gerard.cli.rpc_client import cleanup_clients, get_tool_client
