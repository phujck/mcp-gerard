...
def read(
    ...
    from mcp_gerard.google_calendar.shared import read as _read
...
def create(
    ...
    from mcp_gerard.google_calendar.shared import create as _create
...
def update(
    ...
    from mcp_gerard.google_calendar.shared import update as _update
...
def delete(
    ...
    from mcp_gerard.google_calendar.shared import delete as _delete
