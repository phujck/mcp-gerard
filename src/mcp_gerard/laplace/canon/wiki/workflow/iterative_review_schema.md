...
* **Mandatory Minimum 2-Pass Independent Review**: An output (whether core text, figures, or code) is not complete until it has been:
  ...
  3. **Hostilely Reviewed**: Evaluated by a distinct agent context (e.g., The Formalist, The Architect) designed explicitly to hunt for flaws - implemented by [hostile_redteam_swarm](canon://skills/hostile_redteam_swarm).
