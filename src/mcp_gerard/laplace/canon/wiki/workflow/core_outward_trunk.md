...
distilled - and every future context sees the new truth automatically. See [Evidence-Schema Flow](canon://workflow/evidence_schema_flow.md). What travels between
