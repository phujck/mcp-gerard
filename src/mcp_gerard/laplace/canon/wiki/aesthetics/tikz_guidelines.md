...
All visual outputs must meet the "Nature-Style" benchmark - see [figure_standard](canon://skills/figure_standard/SKILL.md) and [Visual Aesthetics](canon://aesthetics/visual_mechanics.md). Tolerances for visual flaws are zero.
...
* **TeX-Native Elements**: Axes, labels, and legends must be formatted natively in TeX using `pgfplots`. No imported PNG/PDF text. Enforce with [tikz_mechanic](canon://skills/tikz_mechanic/SKILL.md).
