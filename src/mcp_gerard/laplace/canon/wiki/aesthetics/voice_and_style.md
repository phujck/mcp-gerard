...
* **Figure, code, canon** (the voice in non-prose media). The same mark: composed, austere, nothing decorative. A correct figure can still fail if it does not carry the voice - see [figure_standard](canon://skills/figure_standard/SKILL.md). Canon prose reads in the voice. Code is economical in it. The mark does not stop at the edge of prose.
