...
Invoke the [`hostile_redteam_swarm`](canon://skills/hostile_redteam_swarm/SKILL.md) skill. Have the three reviewers (Formalist, Architect, Pedant) aggressively assault the current draft. You must computationally repair any "naked claims" flagged by deriving the missing math.
