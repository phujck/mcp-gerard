...
def show_help():
    ...
    print("Usage: python -m mcp_gerard <tool_name>")
    print("\nAvailable tools:")
    for tool in tools:
        print(f"  - {tool}")

    print("\nExamples:")
    print("  python -m mcp_gerard vim")
    print("  python -m mcp_gerard llm.chat")
    print("  python -m mcp_gerard google_calendar")
...
def main():
    ...
    module_path = f"mcp_gerard.{tool_name}.tool"
