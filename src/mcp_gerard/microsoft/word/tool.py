...
def read(
    ...
    from mcp_gerard.microsoft.word.shared import read as _read
...
def render(
    ...
    from mcp_gerard.microsoft.word.shared import render as _render
...
def edit(
    ...
    from mcp_gerard.microsoft.word.shared import edit as _edit
