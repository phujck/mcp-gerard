...
from mcp_gerard.microsoft.word.models import Block
...
from mcp_gerard.microsoft.common.constants import (
...
def build_blocks(
    ...
    from mcp_gerard.microsoft.word.ops.tables import table_to_markdown
...
def insert_content_ooxml(
    ...
    """
    from mcp_gerard.microsoft.word.ops.tables import insert_table_relative
...
def append_content_ooxml(
    ...
    Returns the new element (w:p or w:tbl).
    """
    from mcp_gerard.microsoft.word.ops.tables import (
...
def find_replace(
    ...
    """
    from mcp_gerard.microsoft.common.text import replace_in_word_paragraph
...
def insert_markdown_blocks(
    ...
    """
    from mcp_gerard.microsoft.word.ops.lists import add_to_list, create_list
