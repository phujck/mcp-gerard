...
from mcp_gerard.microsoft.word.ops.bookmarks import (
...
from mcp_gerard.microsoft.word.ops.comments import (
    _COMMENTS_EXT_NS,
...
from mcp_gerard.microsoft.word.ops.equations import (
    _MATH_NS,
    _MATH_NSMAP,
...
from mcp_gerard.microsoft.word.ops.footnotes import (
    _FN_CT_NS,
    _FN_REL_NS,
    _FN_W_NS,
    _FN_XML_NS,
...
from mcp_gerard.microsoft.word.ops.headers import (
...
from mcp_gerard.microsoft.word.ops.images import (
    _TEXTBOX_NS,
    _WRAP_API_TO_XML,
    _WRAP_XML_TO_API,
...
from mcp_gerard.microsoft.word.ops.properties import (
...
from mcp_gerard.microsoft.word.ops.revisions import (
    _ALL_REVISION_TAGS,
    _CONTENT_REVISIONS,
...
from mcp_gerard.microsoft.word.ops.sections import (
    _SECTION_START_MAP,
    _SECTPR_ORDER,
...
from mcp_gerard.microsoft.word.ops.styles import (
...
from mcp_gerard.microsoft.word.ops.toc import (
    get_toc_info,
    has_toc,
    insert_toc,
    update_toc_field,
