...
from mcp_gerard.microsoft.word.models import HeaderFooterInfo
from mcp_gerard.microsoft.word.ops.core import (
    make_block_id,
    table_content_for_hash,
)
from mcp_gerard.microsoft.word.ops.fields import (
    insert_field,  # noqa: F401 - re-export
)
from mcp_gerard.microsoft.word.ops.tables import populate_table
...
def append_to_header_footer(
    ...
    if content_type == "table":
        from mcp_gerard.microsoft.word.ops.tables import _create_table_element
