...
from mcp_gerard.common.pricing import calculate_cost
from mcp_gerard.common.process import run_command
from mcp_gerard.llm.common import load_prompt_text
from mcp_gerard.llm.registry import (
    get_adapter,
    list_all_models,
    resolve_model,
)
from mcp_gerard.llm.shared import chat as _chat
from mcp_gerard.llm.shared import conversation as _conversation
from mcp_gerard.llm.shared import process_llm_request, resolve_generation_adapter
from mcp_gerard.shared.models import LLMResult  # noqa: F401 - used in type hints
...
def chat(
    ...
    output_file: str = Field(
        ...
        "Responses are always stored in memory (~/.mcp-gerard/) and can be "
...
def transcribe(
    ...
    from mcp_gerard.llm.shared import transcribe as _transcribe
...
def ocr(
    ...
    from mcp_gerard.llm.shared import ocr as _ocr
