...
def build_model_registry() -> dict[str, tuple[str, dict[str, Any]]]:
    ...
    """
    from mcp_gerard.llm.model_loader import load_model_config
...
def get_adapter(provider: str, adapter_type: str):
    ...
    """
    if provider == "gemini":
        from mcp_gerard.llm.providers.gemini import adapter
        ...
        from mcp_gerard.llm.providers.openai import adapter
        ...
        from mcp_gerard.llm.providers.claude import adapter
        ...
        from mcp_gerard.llm.providers.mistral import adapter
        ...
        from mcp_gerard.llm.providers.grok import adapter
        ...
        from mcp_gerard.llm.providers.groq import adapter
